select tr.id, tr.campaign_id, tr.coupon_id, tr.customer_id, a.percent_redeemed_on_coupin_id, 
b.percent_redeemed_on_customer_id, c.avg_transaction, c.frequency_of_visit, c.age_on_service, 
d.age_range, d.marital_status, d.rented, d.family_size, d.income_bracket_categorized, tr.redemption_status

from 

(select id, campaign_id, coupon_id, customer_id, redemption_status from train) as tr left join 
...
(select customer_id, age_range, marital_status, rented, family_size, 
...
select a.percent_redeemed_on_coupin_id, 
b.percent_redeemed_on_customer_id, c.avg_transaction, c.frequency_of_visit, c.age_on_service, 
d.age_range, d.is_married, d.rented, d.family_size, d.income_bracket_categorized, tr.redemption_status
